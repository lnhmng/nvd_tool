...
WHERE TRIM(STATION_CODE)=p_STATIONNAME;
...
/*SELECT LINE_NAME,SECTION_NAME,GROUP_NAME,STATION_NAME
INTO p_LINE,p_SECTION,p_GROUP,p_STATION
   ...
   BEGIN
		...
		*/
		...
		ELSIF (p_FAILQTY=1 AND p_PASSQTY=0) THEN
			...
			IF (p_STNTYPE='ICT' OR p_STNTYPE='FBT' OR p_STNTYPE='CRT' OR p_STNTYPE='LCD' OR p_STNTYPE='LCD8030' OR p_STNTYPE='HDTV' OR p_STNTYPE='SLI' OR p_STNTYPE='LCD7020' OR p_STNTYPE='OQA' OR p_STNTYPE='OBA') THEN
   			    UPDATE SFISM4.R_WIP_TRACKING_T
...
IF RES='OK' THEN
   ...
   ELSIF p_PASSQTY=1 AND p_FAILQTY=1 THEN
	  ...
	  --ELSIF p_STNTYPE='FBT' THEN
	  --BELOW MODIFY BY HUANGCANZHOU 20030719
	  ELSIF p_STNTYPE='FBT' OR p_STNTYPE='CRT' OR p_STNTYPE='LCD' OR p_STNTYPE='SLI' OR p_STNTYPE='LCD7020' OR p_STNTYPE='LCD8030' OR p_STNTYPE='HDTV' OR p_STNTYPE='OQA' OR p_STNTYPE='OBA' THEN
	     RES:='2';
	  ELSE
	  	 RES:='0';
	  END IF;
   ...
   ELSIF p_PASSQTY=0 AND p_FAILQTY=1 THEN
   	  --IF (p_STNTYPE='ICT' OR p_STNTYPE='FBT') THEN
   	  --below modify by Huangcanzhou 20030719
   	  IF (p_STNTYPE='ICT' OR p_STNTYPE='FBT' OR p_STNTYPE='CRT' OR p_STNTYPE='LCD' OR p_STNTYPE='LCD8030' OR p_STNTYPE='SLI' OR p_STNTYPE='LCD7020' OR p_STNTYPE='HDTV' OR p_STNTYPE='OQA' OR p_STNTYPE='OBA') THEN
      	 	RES:='2';
	  ELSE
	  	RES:='1';
	  END IF;
