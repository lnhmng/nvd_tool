PROCEDURE       PS2_CHECK_SMT_NEWKPN(STATION_NUM IN VARCHAR2,MACHINE IN VARCHAR2,
...
/*    V_TEMP_KP:=SUBSTR(TRIM(KPN_NEW_NEW_NEW),2);*/
    if SUBSTR(TRIM(KPN_NEW),1,1)='P' THEN
     V_TEMP_KP:=SUBSTR(TRIM(KPN_NEW),2);
	 ELSE
