PROCEDURE             Make_Feeder_Bom_Line_G5 (
   --
...
IS
   ...
   --
   CURSOR c_FeederPN (vBomNo VARCHAR2)
   IS
   ...
   LOOP                                                                --first
      ...
      LOOP
         ...
         LOOP
            ...
            IF MachineCodeIndex = BomNoIndex
            THEN                                     ---The longest if content
               DELETE sfism4.R_SMT_PROD_BOM_T
                WHERE     PRODUCT_NO = PN
               ...
               INSERT INTO sfism4.R_SMT_PROD_BOM_T (PRODUCT_NO,
                                                    VER,
                                                    LINE_NAME,
                                                    BOM_NO,
                                                    EMP_NO)
               ...
               DELETE sfis1.C_SMT_BOM_T
                WHERE BOM_NO = BomNo AND MACHINE_CODE = MachineCode;
               ...
               LOOP
                  ...
                  SELECT KEY_PART_NO
                    INTO KeyPN
                    FROM sfis1.C_BOM_DETAIL_T
                   WHERE BOM_NO = BomNo AND FEEDER_NO = FeederNo;

                  COMMIT;

                  M_MachineCode :=SUBSTR (MachineCode,1,LENGTH (MachineCode) - 1)||SUBSTR (BomNo, -1);
                 -- M_MachineCode :=SUBSTR (BomNo, -1);

                  INSERT INTO sfis1.C_SMT_BOM_T (BOM_NO,
                                                 MACHINE_CODE,
                                                 FEEDER_NO,
                                                 KEY_PART_NO,
                                                 KP_RELATION,
