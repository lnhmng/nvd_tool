PROCEDURE       SP_GET_MELL_ICT_LOG_SN_CYBORD (
...
BEGIN
   ...
   LOOP
       ...
       select NVL(max(rownum),0)+1 INTO p_num from SFISM4.B2B_MELL_ICT_LOG_T_CYBORD where WORK_DATE=i_work_order;

        Insert into SFISM4.B2B_MELL_ICT_LOG_T_CYBORD
        (
         WORK_DATE,
         FILE_NAME,
