...
BEGIN
   ...
   THEN
      ...
      THEN
         res := SUBSTR(DATA,1,13) || ' BEING PRE LOCKED';
         RAISE e_null;
      END IF;
   END IF;
...
----------*****add By Derrick Chow for tickets:S000001GKK 2013-11-22 10:20:11******---------
   ...
   SELECT COUNT (0)
    ...
    WHERE rlt.serial_number = SUBSTR(DATA,1,13)
      ...
      THEN
         ...
         ELSE
            INSERT INTO sfism4.r_nvbios_model_spare_t
                 ...
                 VALUES (SUBSTR(DATA,1,13), c_model, c_bios,
