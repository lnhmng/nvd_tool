...
BEGIN
   ...
   END;
    ...
    WHERE     PRG_NAME = 'MELLANOX_REPORT'
          AND vr_class = 'NVD'
          AND VR_ITEM = 'MELLANOX_GET_REPORT_DATA_T'
          AND vr_name = 'LAST_GET_TIME_FOR_12';
   ...
   v_start_time := TO_CHAR (TO_DATE (v_start_date, 'YYYY/MM/DD'), 'YYYY/MM/DD') || ' 12:00:00';
   v_end_time := v_end_date || ' 23:59:59';
  --   v_end_time := v_end_date || ' 00:00:00';  --系統獲取第二天晨時 00：00：00
   ...
   UPDATE sfis1.C_PARAMETER_INI
     -- SET vr_value = v_end_time, LAST_MODIFY_DATE = SYSDATE,vr_desc='OK'
      SET vr_value = v_end_date || ' 23:00:00', LAST_MODIFY_DATE = SYSDATE,vr_desc='OK'
    WHERE     PRG_NAME = 'MELLANOX_REPORT'
          AND vr_class = 'NVD'
          AND VR_ITEM = 'MELLANOX_GET_REPORT_DATA_T'
          AND vr_name = 'LAST_GET_TIME_FOR_16';
